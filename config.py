...
class Args:
  ...
  def initialize(parser):
    ...
    parser.add_argument('--bert_dir', default='../../model_hub/hfl_chinese-bert-wwm-ext/',
                        help='bert dir for uer')
    parser.add_argument('--data_dir', default='../../data/coreference_resolution/',
    ...
    parser.add_argument('--max_seq_len', default=144, type=int)
